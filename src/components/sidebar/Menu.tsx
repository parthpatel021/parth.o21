...
const Menu: FC<MenuProps> = ({ }) => {
  ...
  return (
    ...
    >
      ...
      <List
        target="_blank"
        link="https://www.linkedin.com/in/parthpatel021/"
        effect="slideUp"
      >
        <Linkedin color="#0277b5" /> Linkedin
      </List>
      <List target="_blank" link="https://github.com/parthpatel021" effect="slideUp">
        <Github color="#2a9d8f" /> Github
      </List>
      <List
        target="_blank"
        link="https://www.instagram.com/parth.o21/"
        effect="slideUp"
      >
