...
export const projectCard: IProjectSectionCardData[] = [
  {
    id: 1,
    title: 'Canvas Craft',
    techStack: 'React.js, TailwindCSS, Material UI, Node.js, Socket.io',
    imageUrl: 'canvas-craft.png',
    href: 'https://canvascraft.onrender.com/',
  },
  {
    id: 2,
    title: 'E-Cart',
    techStack:
      'React.js, Bootstrap, Node.js, Express.js, Rest APIs, MongoDB',
    imageUrl: 'e-cart.png',
    href: 'https://github.com/parthpatel021/E-Cart',
  },
  {
    id: 3,
    title: 'Netflix Clone',
    techStack:
      'Next.js 13, TailwindCSS, Mongoose, Next Auth, Typescript, Prisma',
    imageUrl: 'netflix-clone.png',
    href: 'https://github.com/parthpatel021/Netflix-Clone',
  },
  {
    id: 4,
    title: 'Chat App',
    techStack: 'React.js, Nodejs, Express, Socket.io',
    imageUrl: 'chat-app.png',
    href: 'https://github.com/parthpatel021/ChatApp',
  },
];
...
export const moreProjects = [
  {
    ...
    techStack: ' designed to manage and visualize product transactions',
    icon: 'shirt',
    href: 'https://transaction-dashboard-302d.onrender.com/',
  },
  {
    id: 2,
    title: 'Resto',
    techStack: 'Online food ordering website',
    icon: 'lottery',
    href: 'https://resto-parthpatel021.onrender.com/',
  },
  {
    id: 3,
    title: 'Tile Tapper',
    techStack: 'simple and interactive tile-tapping game',
    icon: 'share',
    href: 'https://colordash.onrender.com/',
  },

  {
    id: 4,
    title: 'BattleField',
    techStack: 'Detailed in-game performance web app.',
    icon: 'game',
    href: 'https://battlefield-n6ps.onrender.com/',
  },
];
